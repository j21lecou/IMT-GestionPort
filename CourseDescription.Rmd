...
TP-Trinomial (à rendre pour le `r as.Date("2023-03-07")+15`): construction d'un arbre trinomial et valorisation d'une option exotique.
...
TP-BDT (à rendre pour le `r as.Date("2023-03-14")+15`): valorisation d'un option sur obligation avec le modèle de Black-Derman-Toy, optimisation des calculs.
...
TP-AmericanShark (à rendre pour le `r as.Date("2023-03-15")+15`): valorisation d'un produit structuré.
