...
Si $S_t < K_{\textrm{min}}$, alors la valeur d'éxercise est $S_t$, c'est à dire que le capital n'est plus garanti.

Déterminer la valeur de $K_{\textrm{min}}$, en utilisant un arbre binomial, ou  la méthode "LS Monte Carlo".
